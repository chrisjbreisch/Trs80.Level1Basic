...
| Equality and comparisons | Implemented | Numeric equality and ordering compare `int`, `float`, and `double` by value rather than runtime type. | Add string comparison compatibility cases. |
