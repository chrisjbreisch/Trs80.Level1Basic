...
internal static class Program
{
    private static void Main(string[] args)
    {
        ...
        DefineAst(outputDir, "Expression", new List<string>
        {
            ...
            "Binary     : Expression left, Token operator-type, Expression right",
        ...
        DefineAst(outputDir, "Statement", new List<string>
        {
            ...
            "End",
            "For                    : Expression variable, Expression start-value, Expression end-value, Expression step-value",
            "Goto                   : Expression location",
            "Gosub                  : Expression location",
            "If                     : Expression condition, Statement then-statement",
            "Input                  : List<Expression> expressions, bool write-newline",
            "Let                    : Expression variable, Expression initializer",
            "List                   : Expression start-at-line-number",
            "Load                   : Expression path",
            "Merge                  : Expression path",
            "New",
            "Next                   : Expression variable",
            "On                     : Expression selector, List<Expression> locations, bool is-gosub",
            "Print                  : Expression at-position, List<Expression> expressions, bool write-newline",
            "Replace                : ParsedLine line",
            "Read                   : List<Expression> variables",
            "Rem                    : Literal remark",
            "Restore",
            "Return",
            "Run                    : Expression start-at-lineNumber",
    ...
    private static void WriteDisclaimer(TextWriter writer)
    {
        writer.WriteLine("//");
        writer.WriteLine("//");
        writer.WriteLine("// This file is automatically generated by generateAst. Do not modify.");
        writer.WriteLine("//");
        writer.WriteLine("//");
    }
