...
public class Level2CompatibilityTest
{
    ...
    [TestMethod]
    public void Type_Mismatch_Compatibility_Program_Reports_An_Error()
    {
        using var controller = new TestController();
        var program = new List<string> {
            "10 A$=42"
        ...
        controller.ReadErrorLine().Should().Be(" 10  ?A$=42");
    ...
    [TestMethod]
    public void Binary_Type_Mismatch_Compatibility_Program_Reports_An_Error()
    {
        using var controller = new TestController();
        var program = new List<string> {
            "10 PRINT \"3\" * \"4\""
    ...
    [TestMethod]
    public void Negative_Integer_Overflow_Compatibility_Program_Reports_An_Error()
    {
        using var controller = new TestController();
        var program = new List<string> {
            "10 AB%=-32769",
    ...
    [TestMethod]
    public void Single_Overflow_Compatibility_Program_Reports_An_Error()
    {
        using var controller = new TestController();
        var program = new List<string> {
            "10 A!=1.8E+38",
    ...
    [TestMethod]
    public void Double_Overflow_Compatibility_Program_Reports_An_Error()
    {
        using var controller = new TestController();
        var program = new List<string> {
            "10 A#=1.8E+38",
