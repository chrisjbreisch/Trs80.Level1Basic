...
public class ScannerTest
{
    ...
    [TestMethod]
    public void Scanner_Recognizes_Lprint_Keyword()
    {
        using var controller = new TestController();
        IScanner scanner = controller.Scanner;

        var tokens = scanner.ScanTokens(new SourceLine("10 lprint \"hello\""));
    ...
    [TestMethod]
    public void Scanner_Recognizes_System_Keyword()
    {
        using var controller = new TestController();
        IScanner scanner = controller.Scanner;

        var tokens = scanner.ScanTokens(new SourceLine("10 system"));
    ...
    [TestMethod]
    public void Scanner_Recognizes_Set_Keyword()
    {
        using var controller = new TestController();
        IScanner scanner = controller.Scanner;

        var tokens = scanner.ScanTokens(new SourceLine("10 set 23, 20"));
